...
public class _Inicial extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:15^1*/      {
        ...
        __jsp_taghandler_1.setAction("/inicial");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:21^9*/            {
              ...
              __jsp_taghandler_2.setKey("ini.usu");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:25^9*/            {
              ...
              __jsp_taghandler_4.setKey("ini.cla");
          ...
          /*@lineinfo:translated-code*//*@lineinfo:29^51*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
