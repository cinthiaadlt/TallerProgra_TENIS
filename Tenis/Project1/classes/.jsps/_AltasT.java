...
public class _AltasT extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:16^1*/      {
        ...
        __jsp_taghandler_1.setAction("/altt");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:22^9*/            {
              ...
              __jsp_taghandler_2.setKey("altt.nom");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:23^9*/            {
              ...
              __jsp_taghandler_3.setProperty("nombre_t");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:26^9*/            {
              ...
              __jsp_taghandler_4.setKey("altt.pais");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:27^9*/            {
              ...
              __jsp_taghandler_5.setProperty("nom_pais");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:31^36*/            {
          ...
          /*@lineinfo:translated-code*//*@lineinfo:31^69*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
